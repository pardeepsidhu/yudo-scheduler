  ...
  return (
    <div className="container mx-auto ">
      ...
      <Dialog open={viewDialogOpen} onOpenChange={setViewDialogOpen}>
        <DialogContent className="sm:max-w-md rounded-sm gap-2">
          <DialogHeader>
          ...
          <DialogFooter className="flex justify-end gap-3">
            <Button
              ...
              className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 rounded-sm flex items-center h-9"
            >
              <Trash2 className="mr-2 h-4 w-4" />
              Delete
            </Button>
      ...
      <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
        <DialogContent className="sm:max-w-md max-h-[90vh] bg-white rounded-sm shadow-2xl border-0 p-0 overflow-hidden gap-2">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-sm border border-blue-200 shadow-sm space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    className={`h-9 px-3 flex-shrink-0 rounded-sm ${!aiPrompt || waiting ? 'bg-gray-200 text-gray-500' : 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white hover:opacity-90'}`}
                  >
                    {waiting ? (
